      ...
      <div className="flex gap-4 items-end px-4 py-2 rounded-t-xl bg-card border shadow-md">
        ...
        <SellStockDialog>
          ...
          >
            <div
              ref={sellButtonRef}
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-green-600 hover:bg-green-700 shadow-sm h-9 px-4 py-2 text-lg"
            >
